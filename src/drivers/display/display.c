...
unsigned short* DISPLAY_CURSOR_POS_YR;
unsigned short* DISPLAY_CURSOR_POS_XR;
...
void display_init(){
    DISPLAY_CURSOR_POS_YR = kmalloc(sizeof(unsigned short));
    DISPLAY_CURSOR_POS_XR = kmalloc(sizeof(unsigned short));
}

DRIVER(vga, display_init, NULL,
        FLAG_CRITICAL);